  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-grid-slate-100 dark:bg-grid-slate-800 bg-[size:3rem_3rem] opacity-20" />
        ...
        <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-8 text-slate-900 dark:text-white lg:pr-8">
            ...
            <div className="space-y-4">
              ...
              >
                Cùng gia nhập hàng ngàn người đã thay đổi hoàn toàn kỹ năng phỏng vấn của họ với sự đồng hành của AI-Interview!
              </motion.p>
            </div>
            ...
            >
              {features.map((feature, index) => (
                ...
                >
                  <Card className="relative overflow-hidden border-black bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300">
          ...
          <motion.div
            ...
            className="lg:pl-8"
          >
            <Card className="relative overflow-hidden border-transparent bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm shadow-xl">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5" />
