...
function CustomLoginForm() {
    ...
    return (
        <div className="w-full max-w-md flex flex-col items-center justify-center min-[1500px]:translate-x-36 max-sm:px-2">
            ...
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-2">Chào mừng bạn đến với<br/>AI.Interview
            </h2>
            <p className="text-base text-center text-gray-500 mb-6">Đăng nhập để bắt đầu hành trình chinh phục phỏng
                vấn</p>
...
export default function Page() {
    return (
        <div className="min-h-screen w-full flex flex-row bg-transparent">
            ...
            <div
                className="w-full min-h-screen flex items-center justify-center relative bg-[#F7F5EF]"
            >
                <Image
            ...
            <div
                className="w-full min-h-screen flex items-center justify-center relative overflow-hidden bg-[#F7F5EF] max-[1500px]:hidden"
            >
                <Image
                    src={'/bg-top-icon.png'}
                    alt={'Top Icon'}
                    className={'absolute top-0 right-[32rem] max-[1500px]:hidden'}
                    width={100}
                    height={100}
                />
